    ...
    public class HeightPrePass : ScriptableRenderPass
    {
        ...
        public sealed class RenderTargetDebugContext : RenderTargetDebugger.RenderTarget
        {
            public RenderTargetDebugContext()
            {
                ...
                this.textureName = ShaderParams.Textures.WaterHeightBufferName;
                this.propertyID = ShaderParams.Textures._WaterHeightBuffer;
                this.order = 0;
            }
        }
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameContext)
        {
            ...
            using(var builder = renderGraph.AddRasterRenderPass<PassData>("Water Height Pre-pass", out var passData))
            {
                ...
                passData.renderTarget = UniversalRenderer.CreateRenderGraphTexture(renderGraph, renderTargetDescriptor, ShaderParams.Textures.WaterHeightBufferName + cameraData.camera.name, true, FilterMode.Bilinear, TextureWrapMode.Clamp);
                ...
                #if DEBUG
                if (RenderTargetDebugger.InspectedProperty == ShaderParams.Textures._WaterHeightBuffer)
                {
                ...
                builder.SetGlobalTextureAfterPass(passData.renderTarget, ShaderParams.Textures._WaterHeightBuffer);
        ...
        private void Execute(RasterGraphContext context, PassData data)
        {
            ...
            using (new ProfilingScope(cmd, profilerSampler))
            {
                ...
                cmd.SetGlobalInt(ShaderParams.GlobalProperties._WaterHeightPrePassAvailable, 1);
        ...
        public override void OnCameraCleanup(CommandBuffer cmd)
        {
            ...
            cmd.SetGlobalInt(ShaderParams.GlobalProperties._WaterHeightPrePassAvailable, 0);
