...
namespace StylizedWater3
{
    ...
    public partial class StylizedWaterRenderFeature : ScriptableRendererFeature
    {
        ...
        [Tooltip("Pre-renders the depth of all water surfaces into a separate depth texture (_WaterDepthTexture), which can be used in bespoke effects.")]
        ...
        public static bool RequireDepthPrePass;
        protected bool WillExecuteDepthPrePass => RequireDepthPrePass || enableDepthPrePass || underwaterRenderingRequiresDepth;

        //Set if the underwater rendering pass is going to execute this frame
        internal bool underwaterRenderingRequiresDepth;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (currentCam.cameraType != CameraType.Reflection)
            {
                ...
                {
                    Shader.SetGlobalInt(ShaderParams.GlobalProperties._WaterHeightPrePassAvailable, 0);
                }
            }

            if (WillExecuteDepthPrePass)
            {
                depthPrePass.Setup();
