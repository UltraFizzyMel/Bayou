...
namespace StylizedWater3
{
    public static class ShaderParams
    {
        public static class Properties
        {
            ...
            public static readonly int _RiverModeOn = Shader.PropertyToID("_RiverModeOn");
            public static readonly int _RiverModeLegacy = Shader.PropertyToID("_RiverModeLegacy");
            public static readonly int _ZWrite = Shader.PropertyToID("_ZWrite");
            public static readonly int _VertexColorTransparency = Shader.PropertyToID("_VertexColorTransparency");
            public static readonly int _VertexColorFoam = Shader.PropertyToID("_VertexColorFoam");
        }

        public static class GlobalProperties
        {
            public static readonly int _WaterHeightPrePassAvailable = Shader.PropertyToID("_WaterHeightPrePassAvailable");
            public static readonly int _WaterDepthTextureAvailable = Shader.PropertyToID("_WaterDepthTextureAvailable");
        }

        public static class Textures
        {
            public const string WaterHeightBufferName = "_WaterHeightBuffer";
            public static readonly int _WaterHeightBuffer = Shader.PropertyToID(WaterHeightBufferName);
            
            public const string WaterDepthBufferName = "_WaterDepthTexture";
            public static readonly int _WaterDepthTexture = Shader.PropertyToID(WaterDepthBufferName);
        }
