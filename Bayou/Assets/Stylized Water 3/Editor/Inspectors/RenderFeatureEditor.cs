...
namespace StylizedWater3
{
    ...
    public partial class RenderFeatureEditor : Editor
    {
        ...
        private SerializedProperty enableDepthPrePass;
        ...
        private void OnEnable()
        {
            ...
            enableDepthPrePass = serializedObject.FindProperty("enableDepthPrePass");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(enableDepthPrePass);
            ...
            if (heightPrePassSettings.isExpanded)
            {
                ...
                {
                    EditorGUILayout.HelpBox("Height Pre-pass is forcible enabled at the moment, because there are height queries being issued from script.", MessageType.Warning);
                }
            }
